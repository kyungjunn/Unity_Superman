...
namespace GrowNa.Gear
{
    public static class LampTable
    {
        ...
        public const double SingleOfferCost = 1;

        /// <summary>자동 점등 1회에 태울 수 있는 최대 낟알 수.</summary>
        public const int MaxAutoBatch = 4;

        // GDD 5.4 파편 교환. 0 = 교환 불가 티어.
        static readonly double[] ShardExchange = { 0, 0, 0, 0, 3000, 15000, 0, 0 };

        public static double ShardExchangeCost(GearTier tier) => ShardExchange[(int)tier];
        ...
        public static double OfferCost(int count) => SingleOfferCost * Math.Max(0, count);
