...
namespace GrowNa.EditorTools
{
    public static class PanelBuilder
    {
        ...
        static readonly Color Dim = new Color(0.72f, 0.68f, 0.60f);
        static readonly Color Ink = new Color(0.26f, 0.18f, 0.08f);

        public static UpgradePanel BuildUpgradePanel(Transform root)
        {
            ...
            var title = UiFactory.Label("Title", panel.transform, "허수아비 단련", 44, Cream, TextAnchor.MiddleCenter);
            ...
            var close = BuildCloseButton(panel.transform);
            close.onClick.AddListener(() => component.SetOpen(false));

            component.Bind(panel.gameObject, rows);
            return component;
        }
        ...
        public static LampPanel BuildLampPanel(Transform root)
        {
            ...
            Button once = OfferButton(panel.transform, "Offer1", "봉헌 (낟알 100)", new Vector2(-200f, 300f));
            Button ten = OfferButton(panel.transform, "Offer10", "10연 (낟알 900)", new Vector2(200f, 300f));
            Button upgradeButton = OfferButton(panel.transform, "Upgrade", "심지 교체", new Vector2(0f, 180f));

            var cost = UiFactory.Label("UpgradeCost", panel.transform, "", 26, Dim, TextAnchor.MiddleCenter);
            UiFactory.Anchor(cost.gameObject, new Vector2(0.5f, 0f), new Vector2(0.5f, 0f), new Vector2(0f, 120f), new Vector2(760f, 40f));

            var component = panel.gameObject.AddComponent<LampPanel>();
            var close = BuildCloseButton(panel.transform);
            close.onClick.AddListener(() => component.SetOpen(false));

            component.Bind(panel.gameObject, headline, rates, pity, result, cost, flame, once, ten, upgradeButton);
            return component;
        }
        ...
        static Button BuildCloseButton(Transform parent)
        {
