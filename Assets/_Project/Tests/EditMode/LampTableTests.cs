...
namespace GrowNa.Tests
{
    public class LampTableTests
    {
        ...
        [Test]
        public void Offer_cost_follows_gdd()
        {
            Assert.AreEqual(100, LampTable.OfferCost(1));
            Assert.AreEqual(300, LampTable.OfferCost(3));
            Assert.AreEqual(900, LampTable.OfferCost(LampTable.TenOfferCount));
        }
